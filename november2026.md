...
Subject: Cologne Sanskrit Dictionaries update (November 2026)

<!-- DRAFT — fill in using: python scripts/draft-newsletter.py --since 2026-10-01 --until 2026-10-31 --output draft.md -->
