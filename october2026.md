...
Subject: Cologne Sanskrit Dictionaries update (October 2026)

<!-- DRAFT — fill in using: python scripts/draft-newsletter.py --since 2026-09-01 --until 2026-09-30 --output draft.md -->
