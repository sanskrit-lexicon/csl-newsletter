...
Subject: Cologne Sanskrit Dictionaries update (September 2026)

<!-- DRAFT — fill in using: python scripts/draft-newsletter.py --since 2026-08-01 --until 2026-08-31 --output draft.md -->
