...
Subject: Cologne Sanskrit Dictionaries update (December 2026)

<!-- DRAFT — fill in using: python scripts/draft-newsletter.py --since 2026-11-01 --until 2026-11-30 --output draft.md -->
